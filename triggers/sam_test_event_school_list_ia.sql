drop trigger if exists `sam_test_event_school_list_ia` //

create definer=`dbadmin`@`localhost` trigger `sam_test_event_school_list_ia` after insert on `sam_test_event_school_list` 
for each row
...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/triggers/sam_test_event_school_list_ia.sql $
$Id: sam_test_event_school_list_ia.sql 6928 2009-04-10 14:08:29Z randall.stanley $ 
*/
