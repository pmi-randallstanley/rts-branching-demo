drop trigger if exists `sam_test_event_school_list_ua` //

create definer=`dbadmin`@`localhost` trigger `sam_test_event_school_list_ua` after update on `sam_test_event_school_list` 
for each row
...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/triggers/sam_test_event_school_list_ua.sql $
$Id: sam_test_event_school_list_ua.sql 6928 2009-04-10 14:08:29Z randall.stanley $ 
*/

begin

    if  old.release_flag      != new.release_flag  then
