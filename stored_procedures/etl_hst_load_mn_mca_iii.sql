...
drop procedure if exists etl_hst_load_mn_mca_iii//
CREATE DEFINER=`dbadmin`@`localhost` PROCEDURE `etl_hst_load_mn_mca_iii`()
    contains SQL
...
proc: begin
    ...
    set v_ods_table := 'pmi_ods_mn_mca_iii';
    set v_ods_view := 'v_pmi_ods_mn_mca_iii';
    ...
    if v_view_exists > 0 then
        ...
        from v_pmi_ods_mn_mca_iii as ods
        ...
        from    v_pmi_ods_mn_mca_iii as ods2
        ...
        from    v_pmi_ods_mn_mca_iii as ods3
