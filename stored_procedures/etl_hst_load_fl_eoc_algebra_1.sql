...
drop procedure if exists etl_hst_load_fl_eoc_algebra_1//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_fl_eoc_algebra_1()
contains sql
...
proc: begin 
  ...
  declare v_subject_cursor cursor for
    ...
    set v_ods_table = 'pmi_ods_fl_eoc_algebra_1';
    set v_ods_view = 'v_pmi_ods_fl_eoc_algebra_1';
    ...
    if v_view_exists > 0 then
        ...
        from    v_pmi_ods_fl_eoc_algebra_1 as ods
        ...
        ;
            ...
            from    v_pmi_ods_fl_eoc_algebra_1 as ods2
            ...
            from    v_pmi_ods_fl_eoc_algebra_1 as ods3
