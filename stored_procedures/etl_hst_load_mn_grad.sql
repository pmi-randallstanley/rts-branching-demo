...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/stored_procedures/etl_hst_load_mn_grad.sql $
...
proc: begin 
    ...
    set v_ods_table := 'pmi_ods_mn_grad_test';
    set v_ods_view := 'v_pmi_ods_mn_grad_test';
