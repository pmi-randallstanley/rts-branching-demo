...
drop procedure if exists etl_hst_load_ky_nwea//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_ky_nwea()
contains sql
...
proc: begin
    ...
    declare v_column_strand_score varchar(50);
    ...
    if v_view_exists > 0 then
        ...
        CREATE TABLE `tmp_subject_list` (
          ...
          `client_ayp_subject_code` varchar(50) NOT NULL,
        ...
        CREATE TABLE `tmp_strand_list` (
          ...
          `column_strand_score` varchar(50) NOT NULL,
        ...
        CREATE TABLE `tmp_stu_admin` (
          ...
          `alt_ayp_score` decimal(9,3) default NULL,
        ...
        select  ods.test_start_date as ods_test_date
            ,max(str_to_date(ods.test_start_date, '%m/%d/%Y')) as test_date
        from v_pmi_ods_nwea as ods
        group by    ods.test_start_date
        ;
        ...
        select  ayps.ayp_subject_id
            ,ayps.ayp_strand_id
            ,min(sc.moniker) as column_strand_score
        ...
        select  ods.row_num
            ...
            ,month(dt.test_date)
            ,sy.school_year_id
            ,cast(ods.test_rit_score as decimal(9,3))
            ,cast(ods.test_percentile as decimal(9,3)) 
            ,ods.grade
        ...
        join    tmp_test_date dt
                on      ods.test_start_date = dt.ods_test_date
        join    c_student as s
        ...
        join    tmp_subject_list as sub
                on      ods.test_name = sub.client_ayp_subject_code
        ...
        and     ods.test_rit_score REGEXP '^[0-9]' > 0
        union all
        select  ods2.row_num
            ,ods2.student_id
            ,ods2.test_name
            ,ods2.test_start_date
            ,s2.student_id
            ,sub2.ayp_subject_id
            ,month(dt2.test_date)
            ,sy2.school_year_id
            ,cast(ods2.test_rit_score as decimal(9,3))
            ,cast(ods2.test_percentile as decimal(9,3))
            ,ods2.grade
            ,v_school_unassigned_id
        ...
        from    v_pmi_ods_nwea as ods2
        join    tmp_test_date dt2
                on      ods2.test_start_date = dt2.ods_test_date
        ...
        join    tmp_subject_list as sub2
                on      ods2.test_name = sub2.client_ayp_subject_code
        ...
        and     ods2.test_rit_score REGEXP '^[0-9]' > 0
        union all
        select  ods3.row_num
            ,ods3.student_id
            ,ods3.test_name
            ,ods3.test_start_date
            ,s3.student_id
            ,sub3.ayp_subject_id
            ,month(dt3.test_date)
            ,sy3.school_year_id
            ,cast(ods3.test_rit_score as decimal(9,3))
            ,cast(ods3.test_percentile as decimal(9,3))
            ,ods3.grade
            ,v_school_unassigned_id
        ...
        from    v_pmi_ods_nwea as ods3
        join    tmp_test_date dt3
                on      ods3.test_start_date = dt3.ods_test_date
        ...
        join    tmp_subject_list as sub3
                on      ods3.test_name = sub3.client_ayp_subject_code
       left join c_student_year as syr3
        ...
        and     ods3.test_rit_score REGEXP '^[0-9]' > 0
        ...
        into v_ayp_subject_id, v_ayp_strand_id, v_column_strand_score;
