drop procedure if exists etl_hst_load_mn_mod_iii//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_mn_mod_iii()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_mn_mod_iii';
    set v_ods_view = 'v_pmi_ods_mn_mod_iii';
    ...
    if v_view_exists > 0 then
        ...
        join    c_ayp_subject as sub
                ...
                and sub.ayp_subject_code like 'mcamodIII%'
        ...
        from    v_pmi_ods_mn_mod_iii as ods
