...
drop procedure if exists etl_hst_load_wy_paws//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_wy_paws()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_wy_paws';
    set v_ods_view = 'v_pmi_ods_wy_paws';
    ...
    if v_view_exists > 0 then
            ...
            from    v_pmi_ods_wy_paws as ods2
            ...
            from    v_pmi_ods_wy_paws as ods3
