...
drop procedure if exists etl_hst_load_nj_ask//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_nj_ask()
contains sql
...
proc: begin 
    ...
    if v_view_exists > 0 then
            ...
            drop table if exists `tmp_ayp_strand_pp`;
        ...
        into v_ayp_subject_id, v_ayp_strand_id, v_column_pe,v_column_ss;
            ...
            SET @sql_text := concat(@sql_text,' insert c_ayp_strand_student (ayp_subject_id, ayp_strand_id, student_id, school_year_id '
                                             ...
                                             ,'  sadmin.school_year_id ,'
                                             ,' sadmin.test_month, '
                                             ,' case when spp.ayp_subject_code= ''njaskLangArtsLiter'' and spp.ayp_strand_code IN(''njaskLangArtsLiterWPers'',''njaskLangArtsLiterWPict'') then ' ,v_column_pe
