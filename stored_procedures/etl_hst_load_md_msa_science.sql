...
drop procedure if exists etl_hst_load_md_msa_science//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_md_msa_science()
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_msa_science';
    set v_ods_view = 'v_pmi_ods_msa_science';
    ...
    if v_view_exists > 0 then
            ...
            from    v_pmi_ods_msa_science as ods
            join    c_student as s
            ...
            from    v_pmi_ods_msa_science as ods2
            ...
            from    v_pmi_ods_msa_science as ods3
