...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/stored_procedures/etl_hst_load_fl_fcat_math_reading.sql $
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_fcat_math_reading';
    set v_ods_view = 'v_pmi_ods_fcat_math_reading';
    ...
    if v_view_exists > 0 then
     ...
     ##############################################################################
        ...
        from    v_pmi_ods_fcat_math_reading as ods
        ...
        from        v_pmi_ods_fcat_math_reading as ods2
        ...
        INTO  v_ayp_subject_id, v_ayp_score_col, v_alt_ayp_score_col;
            ...
            SET @sql_text := concat('insert c_ayp_subject_student (student_id,ayp_subject_id,school_year_id, month_id, ayp_score, alt_ayp_score, last_user_id,create_timestamp)'
                                ...
                                , ' FROM v_pmi_ods_fcat_math_reading AS m ' 
