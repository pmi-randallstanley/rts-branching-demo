...
drop procedure if exists etl_hst_load_nj_eoc_biology //

create definer=`dbadmin`@`localhost` procedure etl_hst_load_nj_eoc_biology()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_nj_eoc_biology';
    set v_ods_view = 'v_pmi_ods_nj_eoc_biology';
    ...
    if v_view_exists > 0 then
            ...
            from    v_pmi_ods_nj_eoc_biology as ods
            join    c_student as s
            ...
            from    v_pmi_ods_nj_eoc_biology as ods2
            ...
            from    v_pmi_ods_nj_eoc_biology as ods3
            ...
            union all
            select  ods4.row_num
                    ,ods4.sis_student_code
                    ,s4.student_id
                    ,coalesce(ods4.test_month,0) as month_id
                    ,ods4.school_year
                    ,ods4.grade_code
                    ,ods4.state_school_code
                    ,case when sty4.school_year_id is null then 1 
                          when sty4.school_year_id is not null and sty4.grade_level_id = v_grade_unassigned_id then 1
                      end as backfill_needed_flag
            from    v_pmi_ods_nj_eoc_biology as ods4
            join    c_student as s4
                    on    s4.student_code = ods4.sis_student_code
            left join c_student_year as sty4
                    on    sty4.student_id = s4.student_id 
                    and   sty4.school_year_id = ods4.school_year
            where   ods4.sis_student_code is not null            
