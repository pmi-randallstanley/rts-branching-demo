...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/stored_procedures/etl_c_ayp_sub_stu_upd_sor_last.sql $
$Id: etl_c_ayp_sub_stu_upd_sor_last.sql 8019 2009-12-14 20:18:55Z randall.stanley $ 
 */

drop procedure if exists etl_c_ayp_sub_stu_upd_sor_last//

create definer=`dbadmin`@`localhost` procedure etl_c_ayp_sub_stu_upd_sor_last(p_ayp_subject_id int(11))
contains sql
...
proc: begin 
    ...
    # set score_record_flag to most recent
    ...
    join    (
                select  ss2.student_id
                    ,ss2.ayp_subject_id
                    ,ss2.school_year_id
                    ,max(sym.academic_year_order) as acad_year_order
