...
drop procedure if exists etl_hst_load_fl_fcat_science_20//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_fl_fcat_science_20()
contains sql
...
proc: begin 
    ...
    set v_ods_table := 'pmi_ods_fcat_science_20';
    set v_ods_view := 'v_pmi_ods_fcat_science_20';
    ...
    if v_view_exists > 0 then
     ...
     ##############################################################################
        ...
        from    v_pmi_ods_fcat_science_20 as ods
        ...
        from    v_pmi_ods_fcat_science_20 as ods2
        ...
        from    v_pmi_ods_fcat_science_20 as ods3
        ...
        INTO  v_ayp_subject_id, v_ayp_score_col_name;
            ...
            SET @sql_text := concat('insert c_ayp_subject_student (student_id,ayp_subject_id,school_year_id, month_id, ayp_score,last_user_id,create_timestamp)'
                                ...
                                , ' FROM v_pmi_ods_fcat_science_20 AS m ' 
