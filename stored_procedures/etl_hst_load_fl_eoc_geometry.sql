...
drop procedure if exists etl_hst_load_fl_eoc_geometry//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_fl_eoc_geometry()
contains sql
...
proc: begin 
  ...
  declare v_subject_cursor cursor for
    ...
    set v_ods_table = 'pmi_ods_fl_eoc_geometry';
    set v_ods_view = 'v_pmi_ods_fl_eoc_geometry';
    ...
    if v_view_exists > 0 then
        ...
        from    v_pmi_ods_fl_eoc_geometry as ods
        ...
        ;
            ...
            from    v_pmi_ods_fl_eoc_geometry as ods2
            ...
            from    v_pmi_ods_fl_eoc_geometry as ods3
