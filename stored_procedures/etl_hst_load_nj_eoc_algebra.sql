...
drop procedure if exists etl_hst_load_nj_eoc_algebra//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_nj_eoc_algebra()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_nj_eoc_algebra';
    set v_ods_view = 'v_pmi_ods_nj_eoc_algebra';
    ...
    if v_view_exists > 0 then
            ...
            drop table if exists  `tmp_eoc_date_conversion`;
            ...
            create table `tmp_eoc_date_conversion` (
          `test_mo_year` varchar(10) not null,
          `test_month` tinyint(2) not null,
        ...
        insert into tmp_eoc_date_conversion (
            test_mo_year
            ,test_month
            ,test_date
        )
        ...
        from    v_pmi_ods_nj_eoc_algebra as ods
        ...
        ;
            ...
            from    v_pmi_ods_nj_eoc_algebra as ods
            join    c_student as s
                    on    s.student_code = ods.state_student_code
            join    tmp_eoc_date_conversion as dte
            ...
            where   ods.state_student_code is not null
            union all
            select  ods2.row_num
                    ,ods2.state_student_code
                    ,s2.student_id
                    ,ods2.test_mo_year
            ...
            from    v_pmi_ods_nj_eoc_algebra as ods2
            join    c_student as s2
                    on    s2.student_state_code = ods2.state_student_code
            join    tmp_eoc_date_conversion as dte2
            ...
            where   ods2.state_student_code is not null
            union all
            select  ods3.row_num
                    ,ods3.state_student_code
                    ,s3.student_id
                    ,ods3.test_mo_year
            ...
            from    v_pmi_ods_nj_eoc_algebra as ods3
            join    c_student as s3
                    on    s3.fid_code = ods3.state_student_code
            join    tmp_eoc_date_conversion as dte3
            ...
            where   ods3.state_student_code is not null
