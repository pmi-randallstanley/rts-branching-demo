drop procedure if exists etl_hst_load_mn_aa//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_mn_aa()
contains sql
...
proc: begin 
    ...
    */
    ...
    set v_ods_table = 'pmi_ods_mn_aa';
    set v_ods_view = 'v_pmi_ods_mn_aa';
    ...
    if v_view_exists > 0 then
        ...
        */
        ...
        where ods.write_score REGEXP '^[0-9]' > 0
        union all
        select  ods.row_num
            ,ods.student_eid
            ,ods.subject_code
