...
drop procedure if exists etl_hst_load_ga_ghsgt_science_gps//


create definer=`dbadmin`@`localhost` procedure etl_hst_load_ga_ghsgt_science_gps()
contains sql
...
proc: begin 
    ...
    if v_view_exists > 0 then
        ...
        where sub.ayp_subject_code ='ghsgtScience'
        ;  
