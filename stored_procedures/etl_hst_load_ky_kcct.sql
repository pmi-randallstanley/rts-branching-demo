...
drop procedure if exists etl_hst_load_ky_kcct//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_ky_kcct()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_ky_kcct';
    set v_ods_view = 'v_pmi_ods_ky_kcct';
    ...
    if v_view_exists > 0 then
            ...
            from    v_pmi_ods_ky_kcct as ods2
            ...
            from    v_pmi_ods_ky_kcct as ods3
