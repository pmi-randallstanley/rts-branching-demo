...
BEGIN 
    ...
    if @table_exists > 0 then
        ...
        SELECT  t.test_id
                ...
                ,case 
                  when sm.scoring_method_code = 's' and coalesce(i.answer_subset_item_code,sr.response_value) = ak.answer then 1 
