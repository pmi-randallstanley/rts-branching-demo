drop procedure if exists etl_hst_load_mn_mod_ii//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_mn_mod_ii()
contains sql
...
proc: begin 
    ...
    set v_ods_table = 'pmi_ods_mn_mod_ii';
    set v_ods_view = 'v_pmi_ods_mn_mod_ii';
    ...
    if v_view_exists > 0 then
        ...
        join    c_ayp_subject as sub
                ...
                and sub.ayp_subject_code like 'mcamodII%'
                and sub.ayp_subject_code not like 'mcamodIII%'
        ...
        from    v_pmi_ods_mn_mod_ii as ods
