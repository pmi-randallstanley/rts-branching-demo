...
$HeadURL: http://atlanta-web.performancematters.com:8099/svn/pminternal/Data/Redwood/Core/stored_procedures/etl_imp_district_admin.sql $
$Id: etl_imp_district_admin.sql 9282 2010-09-28 16:12:18Z randall.stanley $ 
*/


DROP PROCEDURE IF EXISTS etl_imp_district_admin //

CREATE definer=`dbadmin`@`localhost` procedure etl_imp_district_admin()
CONTAINS SQL
...
BEGIN
    ...
    from    (
                ...
                from    v_pmi_ods_district_admins as ods
    ...
    set @sql_string := concat('call ', @db_name_ods, '.imp_set_upload_file_status (\'pmi_ods_district_admins\', \'P\', \'ETL Load Successful\')');
