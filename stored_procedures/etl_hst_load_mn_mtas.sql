drop procedure if exists etl_hst_load_mn_mtas//

create definer=`dbadmin`@`localhost` procedure etl_hst_load_mn_mtas()
contains sql
...
proc: begin 
    ...
    */
    ...
    set v_ods_table = 'pmi_ods_mn_mtas';
    set v_ods_view = 'v_pmi_ods_mn_mtas';
    ...
    if v_view_exists > 0 then
        ...
        join    c_ayp_subject as sub
                ...
                and sub.ayp_subject_code like 'mtas%'
                and sub.ayp_subject_code not like 'mtasIII%'
